...
\newcommand{\orcidlogo}{\includegraphics[height=\fontcharht\font`\B]{orcidlogo.eps}}
...
\begin{document}
	...
	\begin{abstract}
	       We present the solutions to the excercises found in Allen Hatcher's ,,Algebraic Topology'' \cite{} with our own perspective and commentary. We also present proofs of selected theorems.
	\end{abstract}
...
\subsubsection{Simplicial Approximation} Ble ble ble\\
